...
export const questions: Question[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      `A two-step lead qualifier: extract {company, role, intent} from the inbound email, then score it on {fit, urgency, budget}. Both steps produce JSON with known fields.`,
  ...
  },
  {
    ...
    examples: [
      ...
      `"Build a working prototype for this idea" — done is when the prototype runs and passes some smoke checks. The system stops itself when satisfied.`,
    ],
  },
  {
    id: 8,
    ...
    examples: [
      ...
      `You wrote out a fixed workflow in pseudo-code, looked at it honestly, and proved that no static sequence can handle the cases you care about.`,
    ],
  },
  {
    id: 9,
